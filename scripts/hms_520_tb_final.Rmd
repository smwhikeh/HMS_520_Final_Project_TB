...
Our analysis examines TB mortality trends from 2015 to 2020 across age groups, regions, and risk factors using mortality counts from the GBD dataset. 
...
In this study, we leverage the Global Burden of Disease 2021 (GBD 2021) Tuberculosis Estimates to examine TB mortality trends from 2015 to 2020 across different age groups and regions. The dataset includes mortality counts stratified by location, year, and age, as well as estimates of deaths attributable to smoking, alcohol use, and diabetes.

Our primary research questions include:

How have mortality rates changed from 2015 to 2020 across different age groups and regions?
What is the relative contribution of different risk factors (e.g., smoking, alcohol use, and diabetes) to TB mortality in 2015 and 2020?
Do regions or age groups with higher reductions in TB mortality also show lower contributions of risk factors?
